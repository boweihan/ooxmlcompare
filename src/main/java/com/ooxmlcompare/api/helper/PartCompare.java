...
public class PartCompare {
	...
	public static PartCompare compareFileContentExceptCoreOf(String facitFilename, String underTestFilename)
		...
		return PartCompare.compareContentExceptCoreOf(facitInputStream, underTestInputStream);
	}

	public static PartCompare compareContentExceptCoreOf(FileInputStream facitInputStream, FileInputStream underTestInputStream)
		throws IOException {
		PartCompare compare = new PartCompare();
